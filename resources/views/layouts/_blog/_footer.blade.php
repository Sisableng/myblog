<div class="bg-slate-200 mx-auto w-full dark:bg-slate-800 mt-20 rounded-t-3xl">

    <footer class="p-4 px-10 sm:p-6 sm:px-5">
        <div class="md:flex md:justify-between my-10">
            <div class="mb-6 md:mb-0">
                <a href="{{ url('/') }}" class="flex items-center text-2xl">
                    <img src="{{ asset('images/logo.png') }}" class="mr-3 h-8" alt="FlowBite Logo">
                    Ciloa
                    <span class="self-center font-semibold whitespace-nowrap dark:text-white">Media</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 lg:grid-cols-4">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase dark:text-white">Resources</h2>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase dark:text-white">Follow us</h2>
                    <ul class="text-slate-600 dark:text-slate-400">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase dark:text-white">Legal</h2>
                    <ul class="text-slate-600 dark:text-slate-400">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase dark:text-white">Bahasa</h2>
                    <!-- Set Lang -->
                    <div>
                        <button id="dropdownDefault" data-dropdown-toggle="setlang" data-dropdown-placement="bottom"
                            class=" font-medium rounded-full inline-flex items-center dark:text-slate-500"
                            type="button">
                            @if (app()->getLocale())
                            @endif
        ...
        <hr class="my-3 border-slate-200 lg:mx-auto dark:border-slate-700 lg:my-4">
        <div class="lg:flex lg:items-center lg:justify-between">
            ...
            <div class="flex sm:mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="#" class="text-slate-500 hover:text-slate-900 dark:hover:text-white">
