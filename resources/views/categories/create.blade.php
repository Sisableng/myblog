            ...
            <div class="mb-10 p-10 sm:px-5 border border-slate-200 rounded-3xl relative dark:border-slate-700">
                ...
                <div class="mb-10 mt-10 flex sm:flex-col items-start">
                    <label for="category_title"
                        class="required text-slate-900 dark:text-slate-300 w-72 sm:pl-3 sm:mb-5">{{ trans('categories.form.title') }}</label>
                ...
                <div class="mb-10 flex sm:flex-col items-start">
                    <label for="category_slug"
                        class="text-slate-900 dark:text-slate-300 w-72 sm:pl-3 sm:mb-5">{{ trans('categories.form.slug') }}
                        <span class="text-slate-500 italic">(Permalink)</span></label>
                    <input id="category_slug" value="{{ old('slug') }}" name="slug" type="text"
                ...
                <div class="mb-10 flex sm:flex-col items-start relative">
                    <label for="select_category_parent"
                        class="text-slate-900 dark:text-slate-300 w-72 sm:pl-3 sm:mb-5">{{ trans('categories.create.parent-category-label') }}</label>
                ...
                <div class="mb-10 flex sm:flex-col items-start">
                    <label for="descrypt"
                        class="required text-slate-900 dark:text-slate-300 w-72 sm:pl-3 sm:mb-5">{{ trans('categories.form.desc') }}</label>
                ...
                <div class="flex sm:flex-col justify-center items-start w-full">
                    <label for=""
                        class="required text-slate-900 dark:text-slate-300 w-72 sm:pl-3 sm:mb-5">{{ trans('categories.form.thumb') }}</label>
                    <div class="w-full items-center">
                        <label for=""
                            class="flex flex-col justify-center items-center w-full h-64 bg-slate-50 rounded-3xl border-2 border-slate-300 border-dashed dark:bg-slate-700 dark:border-slate-600 dark:hover:border-slate-500 dark:hover:bg-slate-600 @error('thumb') is-invalid @enderror">
                            <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400">SVG, PNG, JPG or GIF (MAX. 800x400px)
                                </p>
                            </div>
                            <input id="input-file" type="text" name="thumb" value="{{ old('thumb') }}"
                                class="border-none bg-transparent w-1/2" readonly>
                        </label>
                        <div id="holder"
