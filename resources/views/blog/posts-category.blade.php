...
@section('title')
    {{ __('blog.title.post_category_title', ['title' => $category->title]) }}
@endsection
@section('content')
    <section class="w-full">
        <div class="relative bg-green-900 h-[30rem] sm:h-80 overflow-hidden">
            ...
            <div class="absolute inset-x-0 inset-y-1/2 w-full flex lg:justify-center justify-start lg:items-center">
                <h1 class="lg:max-w-[50%] text-3xl sm:px-10 text-slate-100">
                    {!! __('blog.title.post_category', ['title' => $category->title]) !!}
                </h1>
            </div>
        </div>
    </section>
