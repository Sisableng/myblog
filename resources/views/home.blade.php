...
<div id="toast-top-right" class="absolute top-5 right-5 w-full max-w-xs p-4 text-gray-900 bg-slate-300/30 backdrop-blur rounded-lg shadow-2xl dark:bg-gray-800 dark:text-gray-300" role="alert">
    <div class="flex items-center mb-3">
        <span class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">New notification</span>
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 text-gray-900 hover:text-green-500 p-1.5 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white" data-dismiss-target="#toast-top-right" aria-label="Close">
    ...
    <div class="flex items-center">
        <div class="relative inline-block shrink-0">
            <img class="w-12 h-12 rounded-full" src="https://www.gravatar.com/avatar/bd3bf537ce5a0c6a8bdc1e674fd39a65.jpg?s=320&d=monsterid" alt="Jese Leos image">
            <span class="absolute bottom-0 right-0 inline-flex items-center justify-center w-6 h-6 bg-green-500 rounded-full">
